...
Introducción a Machine Learning con Scikit-Learn. Conjuntos de training Test, partir en trocitos con training Test y acotar el error con StandardScaler() con la librería LinearRegression() para crear un modelo predictivo.
